...
Any syntactical errors or wrong hint names are reported as an syntax error. These errors are reported in the server log with the message level which specified by pg\_hint\_plan.message\_level if pg\_hint\_plan.debug\_print is on and aboves.
