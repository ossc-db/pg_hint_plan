...
JumbleExpr(pgssJumbleState *jstate, Node *node)
{
	...
	switch (nodeTag(node))
	{
		...
		case T_SubscriptingRef:
			{
				SubscriptingRef   *sref = (SubscriptingRef *) node;

				JumbleExpr(jstate, (Node *) sref->refupperindexpr);
				JumbleExpr(jstate, (Node *) sref->reflowerindexpr);
				JumbleExpr(jstate, (Node *) sref->refexpr);
				JumbleExpr(jstate, (Node *) sref->refassgnexpr);
			}
			break;
		case T_FuncExpr:
			{
