...
DATA = pg_hint_plan--1.1.2.sql pg_hint_plan--1.0--1.1.1.sql pg_hint_plan--1.1.1--1.1.2.sql
...
STARBALL92 = pg_hint_plan92-$(HINTPLANVER).tar.gz
STARBALLS = $(STARBALL) $(STARBALL92)
...
rpm92: $(STARBALL92)
	MAKE_ROOT=`pwd` rpmbuild -bb SPECS/pg_hint_plan92.spec
